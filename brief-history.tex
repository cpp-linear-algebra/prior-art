...
and John Michopoulos contributed their experiences as
\texttt{Boost.uBlas} developers and with C++ techniques for
implementing Einstein (tensor index) notation.  Cem Bassoy contributed
to the discussion of the value of accepting tensors as an initial part
of this library.  Arthur O'Dwyer reviewed the draft, caught typos, and
started an e-mail conversation that led us to clarify the point in
Section \ref{S:uBlas} about how to resolve full container aliasing
issues.  Many others offered useful insights and suggestions that
enriched this paper and will certainly enrich the library.  This paper
will undergo further revision, so if we omitted your name, please let
us know.
