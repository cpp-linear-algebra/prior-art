...
slower than the Fortran routines it wraps, but users accept and even
welcome this in exchange for interactivity.
...
pivot, it fails, without falling back to a different algorithm or
problem.  If you want to solve the minimum-norm least-squares problem,
you must call a different routine.
